...
function SlideThumbnail({slide, currentIndex, index, goToPage, closeFunction}) {
  ...
  return(
    ...
    >
      <Button aria-label={`Page ${index + 1}`} className={`mx-2 p-2 view img-button comic-strip-page-thumbnail ${(currentIndex === index) ? "comic-strip-page-thumbnail-current" : ""}`} onClick={changeSlide}>
